...
CREATE TABLE "BookingSession" (
    ...
    CONSTRAINT "BookingSession_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "Room" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_Booking" (
    ...
    CONSTRAINT "Booking_bookingSessionId_fkey" FOREIGN KEY ("bookingSessionId") REFERENCES "BookingSession" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Booking" ("addressLine1", "addressLine2", "adultCount", "bookingSource", "bookingType", "checkInDate", "checkOutDate", "childCount", "city", "confirmationEmailSent", "contactEmail", "country", "createdAt", "discountAmount", "firstName", "gender", "id", "infantCount", "lastName", "memberId", "numberOfNights", "paymentStatus", "paymentTransactionId", "petCount", "pricePerNight", "referenceNumber", "roomId", "specialRequests", "state", "status", "taxAmount", "totalPrice", "updatedAt", "zipCode") SELECT "addressLine1", "addressLine2", "adultCount", "bookingSource", "bookingType", "checkInDate", "checkOutDate", "childCount", "city", "confirmationEmailSent", "contactEmail", "country", "createdAt", "discountAmount", "firstName", "gender", "id", "infantCount", "lastName", "memberId", "numberOfNights", "paymentStatus", "paymentTransactionId", "petCount", "pricePerNight", "referenceNumber", "roomId", "specialRequests", "state", "status", "taxAmount", "totalPrice", "updatedAt", "zipCode" FROM "Booking";
DROP TABLE "Booking";
...
CREATE INDEX "Booking_bookingSessionId_idx" ON "Booking"("bookingSessionId");
...
-- CreateIndex
CREATE INDEX "BookingSession_token_idx" ON "BookingSession"("token");

-- CreateIndex
CREATE INDEX "BookingSession_roomId_idx" ON "BookingSession"("roomId");
