...
|---|----------|-----------------|------------|
| 01 | `01-login-page.png` | Login with Guest + Member cards | `http://localhost:3000/` |
| 02 | `02-search-results.png` | Search results with dates filled | `http://localhost:3000/search?...` |
...
| 09 | `09-reservation-history.png` | My Reservations list | `http://localhost:3000/reservations` |
| 10 | `10-reservation-detail.png` | Member reservation detail (manage view) | `/reservations/WYNN-...` |
| 11 | `11-swagger-overview.png` | Swagger UI showing controllers/endpoints | `http://localhost:5116/swagger` |
